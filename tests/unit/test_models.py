...
class TestWasteSchedule:
    ...
    def test_get_next_collection_returns_earliest_future_date(self):
        ...
        future_1 = (datetime.now(timezone.utc) + timedelta(days=20)).isoformat().replace('+00:00', 'Z')
        future_2 = (datetime.now(timezone.utc) + timedelta(days=30)).isoformat().replace('+00:00', 'Z')
        future_3 = (datetime.now(timezone.utc) + timedelta(days=60)).isoformat().replace('+00:00', 'Z')
    ...
    def test_get_next_collection_no_future_dates_returns_none(self):
        ...
        past_1 = (datetime.now(timezone.utc) - timedelta(days=365)).isoformat().replace('+00:00', 'Z')
        past_2 = (datetime.now(timezone.utc) - timedelta(days=180)).isoformat().replace('+00:00', 'Z')
