...
class TestLayouts:
    ...
    def test_title_and_date_creates_image(self, mock_image_new, mock_draw, mock_truetype, 
                                          mock_exists, mock_datetime, mock_logger):
    ...
    @patch('rendering.layouts.ImageDraw.Draw')
    @patch('rendering.layouts.Image.new')
    def test_title_and_date_draws_black_rectangle(self, mock_image_new, mock_draw, 
                                                   mock_truetype, mock_exists, 
                                                   mock_datetime, mock_logger):
    ...
    @patch('rendering.layouts.ImageDraw.Draw')
    @patch('rendering.layouts.Image.new')
    def test_title_and_date_draws_text(self, mock_image_new, mock_draw, mock_truetype,
                                       mock_exists, mock_datetime, mock_logger):
    ...
    @patch('rendering.layouts.ImageDraw.Draw')
    @patch('rendering.layouts.Image.new')
    def test_title_and_date_long_title_uses_smaller_font(self, mock_image_new, mock_draw,
                                                          mock_truetype, mock_exists,
                                                          mock_datetime, mock_logger):
